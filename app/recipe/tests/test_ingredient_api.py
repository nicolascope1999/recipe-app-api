...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_filter_ingredients_assigned_to_recipes(self):
        ...
        recipe = Recipe.objects.create(title='Apple Crumble', time_minutes=5, price=Decimal('6.54'), user=self.user)
    ...
    def test_filtered_ingredeints_unique(self):
        """Test filtered ingredeints returs an unique list"""
